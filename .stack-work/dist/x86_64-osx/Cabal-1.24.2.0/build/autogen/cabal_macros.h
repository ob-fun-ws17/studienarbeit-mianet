...
/* package websocketclient-0.1.0.0 */
#define VERSION_websocketclient "0.1.0.0"
#define MIN_VERSION_websocketclient(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "websocketclient-0.1.0.0-ImC50sbPPkj8ZBV3bn1fE1"

#define CURRENT_PACKAGE_KEY "websocketclient-0.1.0.0-ImC50sbPPkj8ZBV3bn1fE1"
